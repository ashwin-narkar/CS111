...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
			./lab2_add --threads=$j --iterations=$i --sync=m >>lab2_add.csv
	done
done
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
			./lab2_add --threads=$j --iterations=$i --sync=m --yield >>lab2_add.csv
	done
done
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
			./lab2_add --threads=$j --iterations=$i --sync=s >>lab2_add.csv
	done
done
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
			./lab2_add --threads=$j --iterations=$i --sync=s --yield >>lab2_add.csv
	done
done
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
			./lab2_add --threads=$j --iterations=$i --sync=c >>lab2_add.csv
	done
done
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
			./lab2_add --threads=$j --iterations=$i --sync=c --yield >>lab2_add.csv
	done
done
...
echo "Creating csv file for lab2_list now"
if [ -e "lab2_list.csv" ]
then
	rm "lab2_list.csv"
fi
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j >>lab2_list.csv 2>>errs.txt
	done
done
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=i>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=i"
echo ""
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=d>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=d"
echo ""
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=il>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=il"
echo ""
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=dl>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=dl"
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=i --sync=m>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=i"
echo ""
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=d --sync=m>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=d"
echo ""
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=il --sync=m>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=il"
echo ""
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=dl --sync=m>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=dl"
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=i --sync=s>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=i"
echo ""
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=d --sync=s>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=d"
echo ""
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=il --sync=s>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=il"
echo ""
...
for i in ${iter[@]}; do
	for j in ${threads[@]}; do
		./lab2_list --iterations=$i --threads=$j --yield=dl --sync=s>>lab2_list.csv 2>>errs.txt
	done
done
echo "Done yield=dl"
...
for j in ${threads[@]}; do
		./lab2_list --iterations=1000 --threads=$j --sync=m>>lab2_list.csv 2>>errs.txt
done
...
threads=(2 4 8 12 16 24)
for j in ${threads[@]}; do
		./lab2_list --iterations=1000 --threads=$j --sync=s>>lab2_list.csv 2>>errs.txt
done
